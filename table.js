class Table {
    ...
    constructor(search_input_id = '#_search', table_id, config) {

        if (typeof search_input_id != "string")
            throw "search_input_id was expected to be a string!";

        if (typeof table_id != "string")
            throw "table_id was  expected to be a string!";
    ...
    search() {
        var input_id = this.search_input_id
